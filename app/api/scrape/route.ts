...
import { scrapeHackerNews, scrapeProductHunt, enrichWithClaude } from '@/lib/scrapers'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.log('[scrape] hn:', hnLeads.length, 'ph:', phLeads.length)

    let raw = [...hnLeads, ...phLeads]
